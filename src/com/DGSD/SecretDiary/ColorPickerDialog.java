 ...
 * Date: 6/11/11
 * Description: Color Dialog taken from Android API Samples
 */
public class ColorPickerDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ColorPickerView cpv = new ColorPickerView(getContext(), l, mInitialColor);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                l.colorChanged(cpv.mCenterPaint.getColor());
            }
        });
